...
////////////////////////////////////////////////////////////////////////
//
//void detech_state_weather(uint16_t code, String * state_weather_daily, String * code_display ) {
//  Serial.println("Step 1");
//  if (code == 200 || code == 201 || code == 202) {
//    *(state_weather_daily) = "Hard Rain";
//    if (icon_transfer == 100)
//      *(code_display) = "Traind.bmp";
//    else
//      *(code_display) = "Trainn.bmp";
//  }
//  if (code == 230 || code == 231 || code == 232 || code == 233) {
//    *(state_weather_daily) = "Thunderstorm ";
//    if (icon_transfer == 100)
//      *(code_display) = "Td.bmp";
//    else
//      *(code_display) = "Tn.bmp";
...
//    *(state_weather_daily) = "Drizzle";
//    if (icon_transfer == 100)
//      *(code_display) = "Cloudyd.bmp";
//    else
//      *(code_display) = "Cloudyn.bmp";
//  }
//
//  if (code == 500 || code == 501 || code == 502 || code == 511 || code == 520 || code == 521 || code == 522) {
//    *(state_weather_daily) = "Drizzle";
//    if (icon_transfer == 100)
//      *(code_display) = "Haze.bmp";
//    else
//      *(code_display) = "Haze.bmp";
//  }
//
//  if (code == 611 || code == 612 || code == 700 || code == 711 || code == 721 || code == 731 || code == 741 || code == 751) {
//    *(state_weather_daily) = "Haze";
//    if (icon_transfer == 100)
//      *(code_display) = "Hazed.bmp";
//    else
//      *(code_display) = "Hazen.bmp";
//  }
//
//  if (code == 800) {
//    *(state_weather_daily) = "Clear sky";
//    if (icon_transfer == 100)
//      *(code_display) = "Cleard.bmp";
//    else
//      *(code_display) = "Clearn.bmp";
//  }
//  if (code == 801 || code == 802 || code == 803 || code == 804) {
//    *(state_weather_daily) = "Cloudy";
//    if (icon_transfer == 100)
//      *(code_display) = "Cloudyd.bmp";
//    else
//      *(code_display) = "Cloudyn.bmp";
...
//  showmsgXY(10,  20, 1, &FreeSans9pt7b , all_day_data1);
...
//  showmsgXY(10,  20, 1, &FreeSans9pt7b , all_day_data1);
//  showmsgXY(320, 20, 1, &FreeSans9pt7b , all_time1);
//  showmsgXY(300, 200, 2, &FreeSans9pt7b , state_weather_daily);
//
//}
//
//void screen2() {
//  //  state_weather_day11.toCharArray(state_weather_day1, 30);
//  //  code_display_day11.toCharArray(code_display_day1, 30);
//  //  state_weather_day22.toCharArray(state_weather_day2, 30);
//  //  code_display_day22.toCharArray(code_display_day2, 30);
//  //  state_weather_day33.toCharArray(state_weather_day3, 30);
//  //  code_display_day33.toCharArray(code_display_day3, 30);
//  //
//  //  temp_daily11.toCharArray(temp_daily111, 10);  //Convert int to string and string to char to display :)
//  //  temp_daily22.toCharArray(temp_daily222, 10);
//  //  temp_daily33.toCharArray(temp_daily333, 10);
//  //  r_humi11.toCharArray(r_humi111, 10);
//  //  r_humi22.toCharArray(r_humi222, 10);
//  //  r_humi33.toCharArray(r_humi333, 10);
//
//
//  tft.fillScreen(0x1928);
//  for (uint16_t a = 0; a < 3; a++) {
...
//  tft.drawRoundRect(0, 0, 480 , 30, 4, 0x07E0);
//  showmsgXY(10,  20, 1, &FreeSans9pt7b , all_day_data1);
//  showmsgXY(320, 20, 1, &FreeSans9pt7b , all_time1);// all_time1 time_now
//
//  //Chia ô
...
//  nam   = t.substring(0, 4);
//  nam_int = nam.toInt();
//  if (ngay.toInt() < 10) ngay = "0" + ngay;  // So sánh dạng String.
//  //  if (thang == "Jan")  thang_num = "01";  //Dạng String
//  //  if (thang == "Feb")  thang_num = "02";
//  //  if (thang == "Mar")  thang_num = "03";
//  //  if (thang == "Apr")  thang_num = "04";
//  //  if (thang == "May")  thang_num = "05";
//  //  if (thang == "Jun")  thang_num = "06";
//  //  if (thang == "Jul")  thang_num = "07";
//  //  if (thang == "Aug")  thang_num = "08";
//  //  if (thang == "Sep")  thang_num = "09";
//  //  if (thang == "Oct")  thang_num = "10";
//  //  if (thang == "Nov")  thang_num = "11";
//  //  if (thang == "Dec")  thang_num = "12";
//
//  if (thu == "Mon")  thu_int = 2;  //Dạng int
//  if (thu == "Tue")  thu_int = 3;
//  if (thu == "Wed")  thu_int = 4; //Test
//  if (thu == "Thu")  thu_int = 5;
//  if (thu == "Fri")  thu_int = 6;
//  if (thu == "Sat")  thu_int = 7;
//  if (thu == "Sun")  thu_int = 8;
//
//  if (thang == "Jan")  thang_int = 1;  //Dạng int
//  if (thang == "Feb")  thang_int = 2;
//  if (thang == "Mar")  thang_int = 3;
//  if (thang == "Apr")  thang_int = 4;
//  if (thang == "May")  thang_int = 5;
//  if (thang == "Jun")  thang_int = 6;
//  if (thang == "Jul")  thang_int = 7;
//  if (thang == "Aug")  thang_int = 8;
//  if (thang == "Sep")  thang_int = 9;
//  if (thang == "Oct")  thang_int = 10;
//  if (thang == "Nov")  thang_int = 11;
//  if (thang == "Dec")  thang_int = 12;
//}
//////////////////////
//
//
