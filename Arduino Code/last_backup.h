...
//  String a, b, c;
//  a = String(temp_daily);
//  b = String(cloud_daily);
//  c = String(r_humi);
//  a.toCharArray(temp_111, 3);
//  b.toCharArray(cloud_111, 3);
//  c.toCharArray(wind_111, 3);
...
//  b = String(r_humi2);
//  c = String(r_humi3);
//  d = String(temp_daily1);
//  e = String(temp_daily2);
//  f = String(temp_daily3);
//  a.toCharArray(r_humi111, 3);
//  b.toCharArray(r_humi222, 3);
//  c.toCharArray(r_humi333, 3);
//  d.toCharArray(temp_daily111, 3);
//  e.toCharArray(temp_daily222, 3);
//  f.toCharArray(temp_daily333, 3);
